...
public interface TmDbApiEN extends TmDbApi {

    @Override
    @GET(TmDbConstants.English.MOVIE_DETAILS_URL)
    Call<MovieBasicResult> getMoviePosterAndBackdrop(@Path("movieid") int movieid);

    @Override
    @GET(TmDbConstants.English.SEARCH_ACTORS_URL)
    ...
    @Override
    @GET(TmDbConstants.English.SEARCH_MOVIES_URL)
    ...
    @Override
    @GET(TmDbConstants.English.SEARCH_MOVIES_BY_ACTOR)
